...
namespace NordVpn.Tray
{
	public class TrayViewModel : AppScreen, IHandle<TrayNotificationCloseRequestedMessage>, IHandle
	{
		...
		public bool IsConnecting
		{
			...
			set
			{
				base.Set<bool>(ref this._isConnecting, value, "IsConnecting");
			}
		}
		...
		public bool ShowQuickConnect
		{
			...
			set
			{
				base.Set<bool>(ref this._showQuickConnect, value, "ShowQuickConnect");
			}
		}
		...
		public bool ShowDisconnect
		{
			...
			set
			{
				base.Set<bool>(ref this._showDisconnect, value, "ShowDisconnect");
			}
		}
		...
		public bool ShowCancelConnecting
		{
			...
			set
			{
				base.Set<bool>(ref this._showCancelConnecting, value, "ShowCancelConnecting");
			}
		}
		...
		public string CurrentConnection
		{
			...
			set
			{
				base.Set<string>(ref this._currentConnection, value, "CurrentConnection");
			}
		}
		...
		private void OnForegroundStatusChanged(object sender, DataEventArgs<bool> e)
		{
			if (e.Data)
			{
				this.RaisePopupCloseRequested();
		...
		{
			if (!this._userPreferences.get_ShowNotifications())
			{
				return;
			}
			switch (currentState)
