...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/h;I)Landroid/support/v7/widget/as;
    .locals 3
...
.method a()V
    ...
    .prologue
    .line 172
    iget-object v0, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/as;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/as;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/as;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/as;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/as;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/as;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/as;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/as;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/au;
    ...
    invoke-virtual {v3, v4, v8}, Landroid/support/v7/widget/au;->g(II)I
    ...
    invoke-virtual {v3, v7}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    .line 63
    invoke-static {v6, v0, v7}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;Landroid/support/v7/widget/h;I)Landroid/support/v7/widget/as;

    move-result-object v7

    iput-object v7, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/as;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/as;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/as;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/as;
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/au;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/au;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/au;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/au;->d(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_2
    iget-object v8, v8, Landroid/support/v7/widget/au;->a:Landroid/content/res/TypedArray;
    ...
    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/au;
    ...
    invoke-virtual {v6, v8}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/au;->e(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/au;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 3210
    :cond_7
    iget-object v1, v6, Landroid/support/v7/widget/au;->a:Landroid/content/res/TypedArray;
