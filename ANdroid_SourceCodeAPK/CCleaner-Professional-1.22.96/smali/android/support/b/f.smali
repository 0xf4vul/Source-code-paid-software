...
.field private static x:Landroid/support/b/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/b/f;->w:[Ljava/lang/String;

    .line 63
    new-instance v0, Landroid/support/b/l;

    invoke-direct {v0}, Landroid/support/b/l;-><init>()V

    sput-object v0, Landroid/support/b/f;->x:Landroid/support/b/l;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/b/f;->a:[I

    .line 67
    iput-boolean v1, p0, Landroid/support/b/f;->b:Z

    .line 69
    iput-boolean v1, p0, Landroid/support/b/f;->c:Z

    return-void
.end method

.method private c(Landroid/support/b/ae;)V
    .locals 7
    ...
    iget-object v1, p0, Landroid/support/b/f;->a:[I
    ...
    iget-object v2, p0, Landroid/support/b/f;->a:[I
...
.method public final a(Landroid/view/ViewGroup;Landroid/support/b/ae;Landroid/support/b/ae;)Landroid/animation/Animator;
    ...
    iget-object v2, v0, Landroid/support/b/ae;->a:Ljava/util/Map;

    .line 121
    move-object/from16 v0, p3

    iget-object v3, v0, Landroid/support/b/ae;->a:Ljava/util/Map;
    ...
    iget-object v4, v0, Landroid/support/b/ae;->b:Landroid/view/View;
    ...
    iget-boolean v3, v0, Landroid/support/b/f;->c:Z
    ...
    iget-boolean v0, v0, Landroid/support/b/f;->b:Z
    ...
    .line 198
    new-instance v3, Landroid/support/b/f$1;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/b/f$1;-><init>(Landroid/support/b/f;)V

    .line 224
    move-object/from16 v0, p0

    invoke-virtual {v0, v3}, Landroid/support/b/f;->a(Landroid/support/b/y$b;)Landroid/support/b/y;
    ...
    .line 278
    new-instance v3, Landroid/support/b/f$2;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/b/f$2;-><init>(Landroid/support/b/f;)V
    ...
    .line 306
    :cond_1f
    new-instance v3, Landroid/support/b/f$3;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Landroid/support/b/f$3;-><init>(Landroid/support/b/f;)V
    ...
    iget-object v7, v0, Landroid/support/b/f;->a:[I
    ...
    .line 329
    invoke-static/range {p1 .. p1}, Landroid/support/b/ah;->c(Landroid/view/View;)Landroid/support/b/ah;

    move-result-object v7

    invoke-virtual {v7, v8}, Landroid/support/b/ah;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v9, v0, Landroid/support/b/f;->a:[I
    ...
    iget-object v10, v0, Landroid/support/b/f;->a:[I
    ...
    iget-object v11, v0, Landroid/support/b/f;->a:[I
    ...
    iget-object v5, v0, Landroid/support/b/f;->a:[I
    ...
    sget-object v5, Landroid/support/b/f;->x:Landroid/support/b/l;
    ...
    .line 339
    new-instance v3, Landroid/support/b/f$4;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v3, v0, v1, v8, v4}, Landroid/support/b/f$4;-><init>(Landroid/support/b/f;Landroid/view/ViewGroup;Landroid/graphics/drawable/BitmapDrawable;Landroid/view/View;)V
...
.method public final a(Landroid/support/b/ae;)V
    ...
    .prologue
    .line 106
    invoke-direct {p0, p1}, Landroid/support/b/f;->c(Landroid/support/b/ae;)V
...
.method public final a()[Ljava/lang/String;
    ...
    .prologue
    .line 73
    sget-object v0, Landroid/support/b/f;->w:[Ljava/lang/String;
