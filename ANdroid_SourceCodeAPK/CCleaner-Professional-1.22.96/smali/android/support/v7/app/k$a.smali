...
.method final a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 290
    iget-object v5, p0, Landroid/support/v7/app/k$a;->c:Landroid/support/v7/app/k;

    .line 1696
    iget-object v0, v5, Landroid/support/v7/app/m;->q:Landroid/support/v7/view/b;
    ...
    .line 1700
    :cond_0
    new-instance v6, Landroid/support/v7/app/m$b;

    invoke-direct {v6, v5, v4}, Landroid/support/v7/app/m$b;-><init>(Landroid/support/v7/app/m;Landroid/support/v7/view/b$a;)V

    .line 1702
    invoke-virtual {v5}, Landroid/support/v7/app/m;->a()Landroid/support/v7/app/a;
    ...
    iput-object v0, v5, Landroid/support/v7/app/m;->q:Landroid/support/v7/view/b;
    ...
    .line 1728
    invoke-virtual {v5}, Landroid/support/v7/app/m;->p()V
    ...
    .line 1750
    :cond_2
    iget-object v0, v5, Landroid/support/v7/app/m;->r:Landroid/support/v7/widget/ActionBarContextView;

    if-nez v0, :cond_3

    .line 1751
    iget-boolean v0, v5, Landroid/support/v7/app/m;->l:Z
    ...
    .line 1754
    iget-object v0, v5, Landroid/support/v7/app/m;->b:Landroid/content/Context;
    ...
    .line 1759
    iget-object v8, v5, Landroid/support/v7/app/m;->b:Landroid/content/Context;
    ...
    iget-object v9, v5, Landroid/support/v7/app/m;->b:Landroid/content/Context;
    ...
    iput-object v8, v5, Landroid/support/v7/app/m;->r:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iput-object v8, v5, Landroid/support/v7/app/m;->s:Landroid/widget/PopupWindow;

    .line 1772
    iget-object v8, v5, Landroid/support/v7/app/m;->s:Landroid/widget/PopupWindow;

    const/4 v9, 0x2

    invoke-static {v8, v9}, Landroid/support/v4/widget/k;->a(Landroid/widget/PopupWindow;I)V

    .line 1774
    iget-object v8, v5, Landroid/support/v7/app/m;->s:Landroid/widget/PopupWindow;

    iget-object v9, v5, Landroid/support/v7/app/m;->r:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 1781
    iget-object v7, v5, Landroid/support/v7/app/m;->r:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v7, v0}, Landroid/support/v7/widget/ActionBarContextView;->setContentHeight(I)V

    .line 1782
    iget-object v0, v5, Landroid/support/v7/app/m;->s:Landroid/widget/PopupWindow;
    ...
    invoke-direct {v0, v5}, Landroid/support/v7/app/m$5;-><init>(Landroid/support/v7/app/m;)V

    iput-object v0, v5, Landroid/support/v7/app/m;->t:Ljava/lang/Runnable;
    ...
    .line 1832
    iput-object v7, v5, Landroid/support/v7/app/m;->q:Landroid/support/v7/view/b;

    .line 1834
    invoke-virtual {v5}, Landroid/support/v7/app/m;->o()Z
    ...
    invoke-virtual {v0, v10}, Landroid/support/v4/view/af;->a(F)Landroid/support/v4/view/af;

    move-result-object v0

    iput-object v0, v5, Landroid/support/v7/app/m;->u:Landroid/support/v4/view/af;

    .line 1837
    iget-object v0, v5, Landroid/support/v7/app/m;->u:Landroid/support/v4/view/af;

    new-instance v1, Landroid/support/v7/app/m$6;

    invoke-direct {v1, v5}, Landroid/support/v7/app/m$6;-><init>(Landroid/support/v7/app/m;)V
    ...
    .line 1866
    iget-object v0, v5, Landroid/support/v7/app/m;->c:Landroid/view/Window;

    invoke-virtual {v0}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v0

    iget-object v1, v5, Landroid/support/v7/app/m;->t:Ljava/lang/Runnable;
    ...
    .line 1814
    :cond_8
    iget-object v0, v5, Landroid/support/v7/app/m;->v:Landroid/view/ViewGroup;
    ...
    .line 1818
    invoke-virtual {v5}, Landroid/support/v7/app/m;->n()Landroid/content/Context;
    ...
    iput-object v0, v5, Landroid/support/v7/app/m;->r:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 1869
    :cond_b
    iput-object v3, v5, Landroid/support/v7/app/m;->q:Landroid/support/v7/view/b;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .line 1084
    iget-boolean v0, v0, Landroid/support/v7/app/k;->p:Z
