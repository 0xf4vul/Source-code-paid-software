...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v7/widget/av;-><init>(Landroid/support/v7/widget/Toolbar;ZI)V
.end annotation
...
.method constructor <init>(Landroid/support/v7/widget/av;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/av;->a:Landroid/support/v7/widget/Toolbar;

    invoke-virtual {v1}, Landroid/support/v7/widget/Toolbar;->getContext()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/av$1;->b:Landroid/support/v7/widget/av;

    iget-object v2, v2, Landroid/support/v7/widget/av;->b:Ljava/lang/CharSequence;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/av;->c:Landroid/view/Window$Callback;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/av$1;->b:Landroid/support/v7/widget/av;

    iget-boolean v0, v0, Landroid/support/v7/widget/av;->d:Z
