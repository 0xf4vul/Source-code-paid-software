...
namespace NordVpn.ServerList.ViewModels
{
	...
	public class ServerViewModel : PropertyChangedBase
	{
		...
		[CompilerGenerated]
		public event EventHandler<DataEventArgs<bool>> FavouriteStatusChanged;
		...
		public VpnState VpnState
		{
			...
			set
			{
				this.Set(ref this._vpnState, value, "VpnState");
			}
		}
		...
		public DistanceValue Distance
		{
			...
			set
			{
				this.Set(ref this._distance, value, "Distance");
			}
		}
		...
		public bool IsFavourite
		{
			...
			set
			{
				if (this.Set(ref this._isFavourite, value, "IsFavourite"))
				{
		...
		{
			EventHandler<DataEventArgs<bool>> expr_06 = this.FavouriteStatusChanged;
			if (expr_06 == null)
			{
				return;
			}
			expr_06(this, new DataEventArgs<bool>(value));
		}
	}
}
