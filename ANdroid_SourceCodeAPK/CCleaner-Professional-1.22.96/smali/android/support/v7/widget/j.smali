...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 72
    instance-of v0, p1, Landroid/support/v4/c/a/d;
    ...
    .line 73
    check-cast v0, Landroid/support/v4/c/a/d;

    invoke-interface {v0}, Landroid/support/v4/c/a/d;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/c/a/d;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/j;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 100
    iput-object v1, p0, Landroid/support/v7/widget/j;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 54
    invoke-virtual {v4, v3}, Landroid/support/v7/widget/au;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v5, p0, Landroid/support/v7/widget/j;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 59
    :cond_2
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/au;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Landroid/support/v7/widget/j;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 1210
    :cond_3
    iget-object v0, v4, Landroid/support/v7/widget/au;->a:Landroid/content/res/TypedArray;
