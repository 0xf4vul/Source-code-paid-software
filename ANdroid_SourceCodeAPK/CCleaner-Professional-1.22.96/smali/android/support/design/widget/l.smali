...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/q;Landroid/support/design/widget/v$d;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2, p3}, Landroid/support/design/widget/j;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/q;Landroid/support/design/widget/v$d;)V
...
.method public final a()F
    ...
    .prologue
    .line 151
    iget-object v0, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final a(FF)V
    ...
    .line 144
    :goto_0
    iget-object v0, p0, Landroid/support/design/widget/l;->o:Landroid/support/design/widget/q;
    ...
    .line 145
    invoke-virtual {p0}, Landroid/support/design/widget/l;->f()V
    ...
    .line 105
    iget-object v2, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v3, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 109
    sget-object v2, Landroid/support/design/widget/l;->j:[I
    ...
    .line 117
    sget-object v2, Landroid/support/design/widget/l;->k:[I
    ...
    iget-object v4, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v8, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 132
    sget-object v2, Landroid/support/design/widget/l;->l:[I
    ...
    .line 139
    sget-object v2, Landroid/support/design/widget/l;->m:[I

    invoke-virtual {v0, v2, v1}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    .line 141
    iget-object v1, p0, Landroid/support/design/widget/l;->n:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final a(I)V
    ...
    .prologue
    .line 76
    iget-object v0, p0, Landroid/support/design/widget/l;->e:Landroid/graphics/drawable/Drawable;
...
.method final a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 51
    invoke-virtual {p0}, Landroid/support/design/widget/l;->h()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/l;->d:Landroid/graphics/drawable/Drawable;

    .line 52
    iget-object v0, p0, Landroid/support/design/widget/l;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/l;->f:Landroid/support/design/widget/d;
    ...
    iget-object v3, p0, Landroid/support/design/widget/l;->f:Landroid/support/design/widget/d;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/l;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/l;->e:Landroid/graphics/drawable/Drawable;

    .line 69
    iget-object v0, p0, Landroid/support/design/widget/l;->e:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Landroid/support/design/widget/l;->g:Landroid/graphics/drawable/Drawable;

    .line 71
    iget-object v0, p0, Landroid/support/design/widget/l;->o:Landroid/support/design/widget/q;

    iget-object v1, p0, Landroid/support/design/widget/l;->e:Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/l;->f:Landroid/support/design/widget/d;
...
.method final b(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/l;->r:Landroid/graphics/drawable/InsetDrawable;

    .line 164
    iget-object v0, p0, Landroid/support/design/widget/l;->o:Landroid/support/design/widget/q;

    iget-object v1, p0, Landroid/support/design/widget/l;->r:Landroid/graphics/drawable/InsetDrawable;
...
.method final g()Landroid/support/design/widget/d;
    .locals 1
