...
namespace NordVpn.Application
{
	public class EventFacade
	{
		...
		{
			return ex is CommunicationException || ex is InfrastructureException || ex is TimeoutException || CommonExceptionsHelper.IsApiCommunicationException(ex);
		}
	}
}
