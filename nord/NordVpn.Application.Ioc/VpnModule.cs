...
namespace NordVpn.Application.Ioc
{
	public class VpnModule : Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
			...
			RegistrationExtensions.RegisterType<CustomConfigsVpnConnector>(builder).WithResolvedParameter(typeof(IVpnServiceManager), "VpnServiceManagerLoggingDecorator").SingleInstance();
			...
			RegistrationExtensions.RegisterType<VpnConnectionManager>(builder).WithResolvedParameter(typeof(IVpnServiceManager), "VpnServiceManagerLoggingDecorator").As<IVpnConnectionManager>().As<IVpnConnectionObserver>().SingleInstance();
