...
namespace NordVpn.Application
{
	public class WpfApplication : IApplication
	{
		...
		[CompilerGenerated]
		public event EventHandler<EventArgs<bool>> ForegoundStatusChanged;
		...
		private void ApplicationOnActivated(object sender, EventArgs e)
		{
			...
			{
				EventHandler<EventArgs<bool>> expr_06 = this.ForegoundStatusChanged;
				if (expr_06 == null)
				{
					return;
				}
				expr_06(this, new EventArgs<bool>(this.IsInForeground));
			};
		}
	}
}
