...
namespace NordVpn.Settings.Legacy
{
	public class LegacyModule : Module
	{
		...
		{
			base.Load(builder);
			RegistrationExtensions.RegisterType<ServerListFactory>(builder).WithResolvedParameter(typeof(IServerProvider), "UserPreferedVpnProtocolServerProvider").SingleInstance();
