.class public final Landroid/support/v7/widget/ae$a;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 143
    iput v3, p0, Landroid/support/v7/widget/ae$a;->h:I

    .line 144
    iput v4, p0, Landroid/support/v7/widget/ae$a;->i:I
    ...
    .line 146
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/ae$a;->h:I

    .line 147
    iput v3, p0, Landroid/support/v7/widget/ae$a;->i:I
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 183
    iget-object v0, p0, Landroid/support/v7/widget/ae$a;->j:Landroid/support/v7/widget/ad;
    ...
    .line 209
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/ae$a;->k:Landroid/view/MenuItem;
    ...
    .line 213
    iget-object v3, p0, Landroid/support/v7/widget/ae$a;->j:Landroid/support/v7/widget/ad;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/ad;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    .line 216
    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/ae$a;->k:Landroid/view/MenuItem;

    .line 218
    if-eqz v1, :cond_1

    .line 219
    iget-object v2, p0, Landroid/support/v7/widget/ae$a;->j:Landroid/support/v7/widget/ad;

    invoke-interface {v2, v0, v1}, Landroid/support/v7/widget/ad;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ae$a;->h:I
    ...
    .line 164
    invoke-virtual {p0, v0, v2, v4, v5}, Landroid/support/v7/widget/ae$a;->performItemClick(Landroid/view/View;IJ)Z
    ...
    iget v0, p0, Landroid/support/v7/widget/ae$a;->i:I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae$a;->setSelection(I)V
...
.method public final setHoverListener(Landroid/support/v7/widget/ad;)V
    .locals 0

    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/ae$a;->j:Landroid/support/v7/widget/ad;
