.class public final Landroid/support/design/internal/f$b;
...
.field final synthetic c:Landroid/support/design/internal/f;

.field private f:Landroid/support/v7/view/menu/j;


# direct methods
.method public constructor <init>(Landroid/support/design/internal/f;)V
    .locals 1

    .prologue
    .line 366
    iput-object p1, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;
    ...
    iput-object v0, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;

    .line 367
    invoke-virtual {p0}, Landroid/support/design/internal/f$b;->b()V
...
.method private a(II)V
    ...
    .line 540
    iget-object v0, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;
    ...
    iput-boolean v1, v0, Landroid/support/design/internal/f$f;->b:Z
...
.method public final synthetic a(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget-object v1, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget-object v1, v1, Landroid/support/design/internal/f;->f:Landroid/view/LayoutInflater;

    iget-object v2, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget-object v2, v2, Landroid/support/design/internal/f;->n:Landroid/view/View$OnClickListener;
    ...
    iget-object v1, v1, Landroid/support/design/internal/f;->b:Landroid/widget/LinearLayout;
...
.method public final a(Landroid/support/v7/view/menu/j;)V
    ...
    .prologue
    .line 546
    iget-object v0, p0, Landroid/support/design/internal/f$b;->f:Landroid/support/v7/view/menu/j;
    ...
    .line 552
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/f$b;->f:Landroid/support/v7/view/menu/j;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 3
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$u;I)V
    ...
    iget-object v1, v1, Landroid/support/design/internal/f;->j:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/f;->h:Z
    ...
    iget v1, v1, Landroid/support/design/internal/f;->g:I
    ...
    iget-object v1, v1, Landroid/support/design/internal/f;->i:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Landroid/support/design/internal/f;->k:Landroid/graphics/drawable/Drawable;
    ...
    .line 4427
    iget-object v1, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;
    ...
    .line 4428
    iget-boolean v2, v1, Landroid/support/design/internal/f$f;->b:Z

    invoke-virtual {v0, v2}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V

    .line 4648
    iget-object v1, v1, Landroid/support/design/internal/f$f;->a:Landroid/support/v7/view/menu/j;
    ...
    .line 5668
    iget v2, v0, Landroid/support/design/internal/f$e;->a:I

    .line 5672
    iget v0, v0, Landroid/support/design/internal/f$e;->b:I
...
.method public final b(I)I
    ...
    .line 1648
    iget-object v0, v0, Landroid/support/design/internal/f$f;->a:Landroid/support/v7/view/menu/j;
...
.method final b()V
    ...
    .prologue
    .line 469
    iget-boolean v0, p0, Landroid/support/design/internal/f$b;->b:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/f$b;->b:Z
    ...
    iget-object v1, v1, Landroid/support/design/internal/f;->c:Landroid/support/v7/view/menu/h;
    ...
    .line 480
    iget-object v0, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget-object v0, v0, Landroid/support/design/internal/f;->c:Landroid/support/v7/view/menu/h;
    ...
    iget-object v6, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget v6, v6, Landroid/support/design/internal/f;->m:I
    ...
    .line 508
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;
    ...
    .line 522
    iget-object v3, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;

    new-instance v4, Landroid/support/design/internal/f$e;

    iget-object v5, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget v5, v5, Landroid/support/design/internal/f;->m:I

    iget-object v9, p0, Landroid/support/design/internal/f$b;->c:Landroid/support/design/internal/f;

    iget v9, v9, Landroid/support/design/internal/f;->m:I
    ...
    .line 530
    iput-boolean v1, v3, Landroid/support/design/internal/f$f;->b:Z
    ...
    .line 527
    iget-object v2, p0, Landroid/support/design/internal/f$b;->a:Ljava/util/ArrayList;
...
.method public final c()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/design/internal/f$b;->f:Landroid/support/v7/view/menu/j;
    ...
    .line 2648
    iget-object v5, v0, Landroid/support/design/internal/f$f;->a:Landroid/support/v7/view/menu/j;
