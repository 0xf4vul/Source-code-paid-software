...
.method public final getItem(I)Ljava/lang/Object;
    ...
    .line 1545
    iget-object v0, v0, Landroid/support/v7/widget/an$b;->a:Landroid/support/v7/app/a$b;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 2293
    new-instance p2, Landroid/support/v7/widget/an$b;

    invoke-virtual {v1}, Landroid/support/v7/widget/an;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {p2, v1, v2, v0}, Landroid/support/v7/widget/an$b;-><init>(Landroid/support/v7/widget/an;Landroid/content/Context;Landroid/support/v7/app/a$b;)V

    .line 2295
    const/4 v0, 0x0

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/an$b;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/an$b;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 2409
    iput-object v1, v0, Landroid/support/v7/widget/an$b;->a:Landroid/support/v7/app/a$b;
