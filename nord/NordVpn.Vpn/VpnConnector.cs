...
namespace NordVpn.Vpn
{
	public class VpnConnector
	{
		...
		[method: CompilerGenerated]
		[CompilerGenerated]
		public event EventHandler<VpnStateChangedEventArgs> VpnStateChangeChanged;
		...
		[AsyncStateMachine(typeof(VpnConnector.<GetVpnConnectionStatus>d__17))]
		public Task<VpnConnectionStatus> GetVpnConnectionStatus()
		{
			VpnConnector.<GetVpnConnectionStatus>d__17 <GetVpnConnectionStatus>d__;
			...
			<>t__builder.Start<VpnConnector.<GetVpnConnectionStatus>d__17>(ref <GetVpnConnectionStatus>d__);
			return <GetVpnConnectionStatus>d__.<>t__builder.Task;
		}

		[AsyncStateMachine(typeof(VpnConnector.<Connect>d__18))]
		public Task Connect(GeographicalServer server)
		{
			VpnConnector.<Connect>d__18 <Connect>d__;
			...
			<>t__builder.Start<VpnConnector.<Connect>d__18>(ref <Connect>d__);
			return <Connect>d__.<>t__builder.Task;
		}

		[AsyncStateMachine(typeof(VpnConnector.<Disconnect>d__19))]
		public Task Disconnect()
		{
			VpnConnector.<Disconnect>d__19 <Disconnect>d__;
			...
			<>t__builder.Start<VpnConnector.<Disconnect>d__19>(ref <Disconnect>d__);
			return <Disconnect>d__.<>t__builder.Task;
		}

		[AsyncStateMachine(typeof(VpnConnector.<ToggleConnect>d__20))]
		public Task ToggleConnect(GeographicalServer server)
		{
			VpnConnector.<ToggleConnect>d__20 <ToggleConnect>d__;
			...
			<>t__builder.Start<VpnConnector.<ToggleConnect>d__20>(ref <ToggleConnect>d__);
			return <ToggleConnect>d__.<>t__builder.Task;
		}

		[AsyncStateMachine(typeof(VpnConnector.<Reconnect>d__21))]
		public Task Reconnect()
		{
			VpnConnector.<Reconnect>d__21 <Reconnect>d__;
			...
			<>t__builder.Start<VpnConnector.<Reconnect>d__21>(ref <Reconnect>d__);
			return <Reconnect>d__.<>t__builder.Task;
		}

		[AsyncStateMachine(typeof(VpnConnector.<TryConnectToServer>d__22))]
		public Task TryConnectToServer(GeographicalServer server)
		{
			VpnConnector.<TryConnectToServer>d__22 <TryConnectToServer>d__;
			...
			<>t__builder.Start<VpnConnector.<TryConnectToServer>d__22>(ref <TryConnectToServer>d__);
		...
		{
			EventHandler<VpnStateChangedEventArgs> expr_06 = this.VpnStateChangeChanged;
			if (expr_06 == null)
			{
				return;
			}
