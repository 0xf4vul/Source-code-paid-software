...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    .line 60
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/au;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 2210
    iget-object v1, v1, Landroid/support/v7/widget/au;->a:Landroid/content/res/TypedArray;
...
.method final d()V
    ...
    .line 3172
    iget-object v2, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/as;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/f;->f:Landroid/support/v7/widget/as;
    ...
    .line 4029
    iput-object v5, v2, Landroid/support/v7/widget/as;->a:Landroid/content/res/ColorStateList;

    .line 4030
    iput-boolean v0, v2, Landroid/support/v7/widget/as;->d:Z

    .line 4031
    iput-object v5, v2, Landroid/support/v7/widget/as;->b:Landroid/graphics/PorterDuff$Mode;

    .line 4032
    iput-boolean v0, v2, Landroid/support/v7/widget/as;->c:Z

    .line 3178
    iget-object v4, p0, Landroid/support/v7/widget/f;->a:Landroid/view/View;
    ...
    .line 3180
    iput-boolean v1, v2, Landroid/support/v7/widget/as;->d:Z

    .line 3181
    iput-object v4, v2, Landroid/support/v7/widget/as;->a:Landroid/content/res/ColorStateList;
    ...
    .line 3185
    iput-boolean v1, v2, Landroid/support/v7/widget/as;->c:Z

    .line 3186
    iput-object v4, v2, Landroid/support/v7/widget/as;->b:Landroid/graphics/PorterDuff$Mode;

    .line 3189
    :cond_2
    iget-boolean v4, v2, Landroid/support/v7/widget/as;->d:Z

    if-nez v4, :cond_3

    iget-boolean v4, v2, Landroid/support/v7/widget/as;->c:Z
    ...
    invoke-static {v3, v2, v0}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;[I)V
    ...
    .line 3162
    :cond_6
    iget-object v2, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/as;
    ...
    .line 127
    invoke-static {v3, v0, v1}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/as;[I)V
