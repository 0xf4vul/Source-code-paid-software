...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/an;->i:Landroid/view/animation/Interpolator;
...
.method private b()Z
    ...
    .line 176
    iget-object v0, p0, Landroid/support/v7/widget/an;->b:Landroid/support/v7/widget/LinearLayoutCompat;
...
.method public final onMeasure(II)V
    ...
    .line 101
    iget-object v4, p0, Landroid/support/v7/widget/an;->b:Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    .line 109
    :goto_1
    iget v3, p0, Landroid/support/v7/widget/an;->c:I
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/an;->b:Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    .line 1156
    iget-object v1, p0, Landroid/support/v7/widget/an;->f:Landroid/widget/Spinner;
    ...
    .line 1157
    iput-object v1, p0, Landroid/support/v7/widget/an;->f:Landroid/widget/Spinner;

    .line 1159
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/an;->b:Landroid/support/v7/widget/LinearLayoutCompat;

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/an;->removeView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/an;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/an;->h:I
    ...
    .line 111
    :cond_8
    iput v6, p0, Landroid/support/v7/widget/an;->c:I
...
.method public final setTabSelected(I)V
    ...
    .line 1261
    iget-object v4, p0, Landroid/support/v7/widget/an;->a:Ljava/lang/Runnable;
    ...
    invoke-direct {v4, p0, v0}, Landroid/support/v7/widget/an$1;-><init>(Landroid/support/v7/widget/an;Landroid/view/View;)V
