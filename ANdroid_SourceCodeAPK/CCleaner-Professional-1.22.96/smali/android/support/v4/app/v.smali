...
# static fields
.field private static final a:Landroid/support/v4/app/v$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/v;->a:Landroid/support/v4/app/v$a;
    ...
    invoke-direct {v0}, Landroid/support/v4/app/v$b;-><init>()V
...
.method public static a(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    .prologue
    .line 216
    sget-object v0, Landroid/support/v4/app/v;->a:Landroid/support/v4/app/v$a;

    invoke-interface {v0, p0}, Landroid/support/v4/app/v$a;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    .line 264
    invoke-static {v1}, Landroid/support/v4/b/c;->a(Landroid/content/ComponentName;)Landroid/content/Intent;
...
.method public static a(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/v$a;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public static b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    .line 302
    sget-object v1, Landroid/support/v4/app/v;->a:Landroid/support/v4/app/v$a;

    invoke-interface {v1, p0, v0}, Landroid/support/v4/app/v$a;->a(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
...
.method public static b(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/v$a;->b(Landroid/app/Activity;Landroid/content/Intent;)V
